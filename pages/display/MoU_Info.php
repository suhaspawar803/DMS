      ...
      <ul class="nav">
        ...
        ?>
          ...
          <li class="nav-item menu-items active">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="#"> MoU Details</a></li>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h3 id="h3head">MoU Details</h3>

              <a href="../forms/MoU_Info.php"><input class="btn btn-primary mr-2" type="button" value="Add Data" /></a><br><br>
              <a href="../reports/mou_info_report.php"><input class="btn btn-primary mr-2" type="button" value="Customize Report" /></a><br><br>
