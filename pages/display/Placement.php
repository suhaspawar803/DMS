			...
			<li class="nav-item menu-items active">
			  ...
			  <div class="collapse" id="auth">
				<ul class="nav flex-column sub-menu">
				  ...
				  <li class="nav-item"><a class="nav-link" href="#">Training & Placement</a></li>
	...
	<!-- main-panel -->
      <div class="main-panel">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h3 id="h3head">Training &amp; Placement</h3>
              <a href="../forms/Placement.php"><input class="btn btn-primary mr-2" type="button" value="Add Data" /></a><br><br>
              <a href="../reports/placement_report.php"><input class="btn btn-primary mr-2" type="button" value="Customize Report" /></a><br><br>
