        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              ...
              <a href="../forms/Research_Paper_Info.php"><input class="btn btn-primary mr-2" type="button" value="Add Data" /></a><br><br>
              <a href="../reports/research_paper_info_report.php"><input class="btn btn-primary mr-2" type="button" value="Customize Report" /></a><br><br>
