			...
			<li class="nav-item menu-items active">
              ...
              <div class="collapse" id="util1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#"> Involvement of Department Staff in various College Committees Work </a></li>
				</ul>
			  </div>
			</li>
			<li class="nav-item menu-items">
	...
	<!-- main-panel -->
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h3 id="h3head">Involvement Of Department Staff In Various College Committees Work</h3>

              <a href="../forms/Staff_Committees.php"><input class="btn btn-primary mr-2" type="button" value="Add Data" /></a><br><br>
              <a href="../reports/staff_committees_report.php"><input class="btn btn-primary mr-2" type="button" value="Customize Report" /></a><br><br>
              ...
              <p style="color:cyan;"><br><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M8 17v-2h8v2H8m8-7l-4 4l-4-4h2.5V7h3v3H16M5 3h14a2 2 0 0 1 2 2v14c0 1.11-.89 2-2 2H5a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2m0 2v14h14V5H5Z"/></svg>&nbsp;Download as<br></p>
