			...
			<li class="nav-item menu-items active">
			  ...
			  <div class="collapse" id="ui-basic">
				<ul class="nav flex-column sub-menu">
				  ...
				  <li class="nav-item"><a class="nav-link" href="#">Student Activities</a></li>
				</ul>
			  </div>
			</li>
			<li class="nav-item menu-items">
	...
	<!-- main-panel -->
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h3 id="h3head">Student Activities</h3>

              <a href="../forms/Student_Activities.php"><input class="btn btn-primary mr-2" type="button" value="Add Data" /></a><br><br>
              <a href="../reports/student_activities_report.php"><input class="btn btn-primary mr-2" type="button" value="Customize Report" /></a><br><br>
