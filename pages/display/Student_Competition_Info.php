        ...
        ?>
          ...
          <li class="nav-item menu-items active">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="users.php">Student Competition</a></li>
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown border-left">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item" href="../utility/recent_record.php"s>
                  <div class="preview-thumbnail">
                    <div class="preview-icon bg-dark rounded-circle">
                  ...
                  <div class="preview-item-content">
                    <p class="preview-subject mb-1">Resent Record Inserted</p>
      ...
      <div class="main-panel">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h3 id="h3head">Sports Activities</h3>
              <a href="../forms/Sport_Activity.php"><input class="btn btn-primary mr-2" type="button" value="Add Data" /></a><br><br>
              <a href="../reports/student_competition_info_report.php"><input class="btn btn-primary mr-2" type="button" value="Customize Report" /></a><br><br>
