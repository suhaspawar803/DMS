      ...
      <!-- content-wrapper -->
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                <center>Alumni Information</center>
              </h4>
              <form class="form-sample" method="POST">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Name of the Dept.</label>
                      <div class="col-sm-9">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Total Alumni of the Dept.</label>
                      <div class="col-sm-9">
                        <input type="text" name="total_alumni" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Real Time Data</label>
                      <div class="col-sm-9">
                        <input type="text" name="real_time_data" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Total Alumni Registered</label>
                      <div class="col-sm-9">
                        <input type="text" name="total_registered" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">MoU</label>
                      <div class="col-sm-9">
                        <input type="text" name="mou" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Lecture</label>
                      <div class="col-sm-9">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Placement</label>
                      <div class="col-sm-9">
                        <input type="text" name="plecement" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
            ...
            if ($_POST) {
              $dept = $_POST['dept'];
              $total_alumni = $_POST['total_alumni'];
              $real_time_data = $_POST['real_time_data'];
              $total_registered = $_POST['total_registered'];
              $mou = $_POST['mou'];
              $lecture = $_POST['lecture'];
              $visit = $_POST['visit'];
              $plecement = $_POST['plecement'];
              $date = $_POST['date'];
              $library = "#";

              include '../../data.php';
              if ($db) {
                $sql = "INSERT INTO alumni_info VALUES(DEFAULT,'$dept', '$total_alumni','$real_time_data', '$total_registered','$mou','$lecture','$visit','$plecement','$date');";
              }
