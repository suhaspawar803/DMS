      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                <center> Consultancy / Extension </center>
              </h4>
              <form class="form-sample" method="POST">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Name of the Department</label>
                      <div class="col-sm-9">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Name of Activity (Consultancy/ Extension)</label>
                      <div class="col-sm-9">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">No. of students benefited</label>
                      <div class="col-sm-9">
                        <input type="text" name="benefited" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
          ...
          if ($_POST) {
            ...
            include '../../data.php';
            if ($db) {
              $sql = "INSERT INTO extainsions VALUES(DEFAULT,'$department','$activity','$benefited','$date');";
            }
