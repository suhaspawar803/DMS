      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                <center>Extra curricular Activity</center>
              </h4>
              <form class="form-sample" method="POST">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">No. of students benefitted</label>
                      <div class="col-sm-9">
                        <input type="text" name="benefitted" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
          ...
          if ($_POST) {
            ...
            $benefitted = $_POST['benefitted'];
            $date = $_POST['date'];

            include '../../data.php';
            if ($db) {
              $sql = "INSERT INTO extra_activity VALUES(DEFAULT,'$department','$activity','$benefitted','$date');";
            }
