      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                <center> Training & Placement </center>
              </h4>
              <form class="form-sample" method="POST">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Name of the Company visited</label>
                      <div class="col-sm-9">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">No. of students Registered</label>
                      <div class="col-sm-9">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">No. of students selected</label>
                      <div class="col-sm-9">
          ...
          if ($_POST) {
            ...
            include '../../data.php';
            if ($db) {
              $sql = "INSERT INTO Placements VALUES(DEFAULT, '$company','$registered','$selected','$date');";
            }
