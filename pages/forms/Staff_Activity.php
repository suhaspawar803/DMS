      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                <center> Staff Activity </center>
              </h4>
              <form class="form-sample" method="POST">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Name of the Teacher (FDP/Seminar/ Workshop/ Conference/ Refresher/ Orientation / Short Term Courses/ Resource Person invited talk/ Paper setting/ any other)</label>
                      <div class="col-sm-9">
          ...
          if ($_POST) {
            ...
            include '../../data.php';
            if ($db) {
              $sql = "INSERT INTO staff_activity VALUES(DEFAULT,'$tname', '$department','$activity','$date');";
            }
