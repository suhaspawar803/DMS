      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                <center> Involvement of Department Staff in various College Committees Work </center>
              </h4>
              <form class="form-sample" method="POST">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Name of the Staff</label>
                      <div class="col-sm-9">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Name of Committee</label>
                      <div class="col-sm-9">
          ...
          if ($_POST) {
            ...
            include '../../data.php';
            if ($db) {
              $sql = "INSERT INTO staff_committee VALUES(DEFAULT,'$tname','$committee','$work','$date');";
            }
