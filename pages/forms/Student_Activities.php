      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                <center> Student Activities</center>
              </h4>
              <form class="form-sample" method="POST">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">No. of students Participated / Benefitted</label>
                      <div class="col-sm-9">
                        <input type="text" name="participated" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          if ($_POST) {
            ...
            include '../../data.php';
            if ($db) {
              $sql = "INSERT INTO student_activity VALUES(DEFAULT,'$department', '$class','$activity','$date','$participated');";
            }
