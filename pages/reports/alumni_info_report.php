              ...
              <form method="POST">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="alumni_total" class="form-check-input">Total Alumni of the Department</label>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="real_time_data" class="form-check-input">Real time Data</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="total_registered" class="form-check-input">Total Alumni Registered</label>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="date" class="form-check-input">Date</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="mou,lecture,visit,placement" class="form-check-input">Activity with Alumni</label>
                    </div>
                  </div>
                </div>
                <div class="row">
        ...
        <div id="tab">
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($_POST["fdate"]) {
              ...
              $sql .= " FROM alumni_info WHERE date BETWEEN '$fdate' AND '$tdate'";
            } else {
              $sql .= " FROM alumni_info;";
            }
            ...
            foreach ($data as $in) {
              switch ($in) {
                case "department":
                  echo "<th rowspan=2>Name Of Department</th>";
                  break;
                case "alumni_total":
                  echo "<th rowspan=2>Total Alumni of the Department</th>";
                  break;
                case "real_time_data":
                  ...
                  case "date":
                      ...
                      break;
                case "mou,lecture,visit,placement":
