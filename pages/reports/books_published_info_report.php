      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="auth1">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><a class="nav-link" href="#">Student Competition</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]data[]" value="tname" class="form-check-input">Name Of The Teacher / Author</label>
                      </div>
                    </div>
					<div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="conference" class="form-check-input">Title Of The Proceedings Of The Conference</label>
                      </div>
                    </div>
					 <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="publisher" class="form-check-input">Name Of The Publisher</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
					 ...
					 <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="isbn_issn" class="form-check-input">ISBN/ISSN</label>
                      </div>
                    </div> 
					<div class="col-md-6">
                      <div class="form-check">
...
if ($_POST["fdate"]) {
  ...
  $sql .= " FROM books_published_info WHERE date BETWEEN '$fdate' AND '$tdate'";
 } else {
  $sql .= " FROM books_published_info;";
}
