                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="department" class="form-check-input"> Name of Department </label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="activity" class="form-check-input"> Name of Activity (Consultancy/ Extension)</label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="total_benefited" class="form-check-input">No. of students benefited</label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-check">
            ...
            <div id="tab">
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($_POST["fdate"]) {
                  ...
                  $sql .= " FROM extainsions WHERE date BETWEEN '$fdate' AND '$tdate'";
                } else {
                  $sql .= " FROM extainsions;";
                }
