                ...
                <div class="row">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="total_students" class="form-check-input">No. of students benefitted</label>
                      </div>
                    </div>
            ...
            <div id="tab">
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($_POST["fdate"]) {
                  ...
                  $sql .= " FROM extra_activity WHERE date BETWEEN '$fdate' AND '$tdate'";
                } else {
                  $sql .= " FROM extra_activity;";
                }
                ...
                foreach ($data as $in) {
                  switch ($in) {
                    ...
                    case "activity":
                      ...
                      break;
                    case "total_students":
                      echo "<th> No. of students benefitted</th>";
                      break;
