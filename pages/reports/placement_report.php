    ...
    <div class="col-md-6">
      <div class="form-check">
        <label class="form-check-label">
          <input type="checkbox" name="data[]" value="cname" class="form-check-input">Name of the Company visited</label>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="form-check">
        <label class="form-check-label">
          <input type="checkbox" name="data[]" value="total_registered" class="form-check-input">No. of students Registered</label>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-check">
        <label class="form-check-label">
          <input type="checkbox" name="data[]" value="total_selected" class="form-check-input">No. of students selected</label>
      </div>
    </div>
  </div>
  <div class="row">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($_POST["fdate"]) {
    ...
    $sql .= " FROM placements WHERE date BETWEEN '$fdate' AND '$tdate'";
  } else {
    $sql .= " FROM placements;";
  }
  ...
  foreach ($data as $dataItem) {
    ...
    switch ($dataItem) {
      ...
      case "total_registered":
        echo "<th>No. of students Registered</th>";
        break;
      case "total_selected":
        echo "<th>No. of students selected</th>";
        break;
      case "date":
        echo "<th>Date</th>";
        break;
