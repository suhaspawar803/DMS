                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="tname" class="form-check-input">Name of the Staff</label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="committee" class="form-check-input">Name of Committee</label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="nature_work" class="form-check-input">Nature of Work</label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-check">
            ...
            <div id="tab" class="card-body">
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($_POST["fdate"]) {
                  ...
                  $sql .= " FROM staff_committee WHERE date BETWEEN '$fdate' AND '$tdate'";
                } else {
                  $sql .= " FROM staff_committee;;";
                }
