              ...
              <form method="POST">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="class" class="form-check-input">Class</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="activity" class="form-check-input">Name of the Activity</label>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" name="data[]" value="total_participated" class="form-check-input">No. of students Participated / Benefitted</label>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
          ...
          <div id="tab">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              if ($_POST["fdate"]) {
                ...
                $sql .= " FROM student_activity WHERE date BETWEEN '$fdate' AND '$tdate'";
              } else {
                $sql .= " FROM student_activity;";
              }
              ...
              foreach ($data as $in) {
                switch ($in) {
                  ...
                  case "total_participated":
                    echo "<th>No. of students Participated / Benefitted</th>";
                    break;
                }
              }
              echo "</tr>";
