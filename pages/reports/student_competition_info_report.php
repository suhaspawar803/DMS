                ...
                <div class="row">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="cname" class="form-check-input">Name of the Activity</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="sname" class="form-check-input"> Name of the students participated </label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="level" class="form-check-input">Level – (Local / District/ University / State / National / International )</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="comp_date" class="form-check-input"> Date </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="data[]" value="awards" class="form-check-input">Award if any.</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
            ...
            <div id="tab">
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($_POST["fdate"]) {
                  ...
                  $sql .= " FROM student_competition_info WHERE date BETWEEN '$fdate' AND '$tdate'";
                } else {
                  $sql .= " FROM student_competition_info;";
                }
