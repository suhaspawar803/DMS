            ...
            <div class="collapse" id="util">
              <ul class="nav flex-column sub-menu">
                ...
                ?>
                  ...
                  if ($role != 'HOD') {
                  ?>
                    <li class="nav-item"><a class="nav-link" href="#">Add/Remove HOD</a></li>
                    <?php
                    if ($role != 'Principal') {
                    ?>
            ...
            <div class="card-body" style="background-color:#191c24;">
              ...
              <div class="preview-icon">
                  <span class="mdi mdi-account-plus" ></span>
                   <span class="menu-title" style="font-size:20px;">Add HOD</span> 
                </div>
              </a>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Name of the HOD</label>
                        <div class="col-sm-9">
            ...
            <div class="card-body" style="max-width:80%;overflow: auto;">
              ...
              <div id="tab" class="card-body">
                ...
                if (isset($_POST['add'])) {
                  ...
                  include '../../data.php';
                  if ($db) {
                    $sql = "INSERT INTO users VALUES(DEFAULT,'$name','$username','$pass','HOD','$library');";
                    $ret = pg_query($db, $sql);
                    if (!$ret) {
                      echo "<br>ERROR...<br>";
                    } else {
                ...
                include '../../data.php';
                if ($db) {
                  $sql = "SELECT * FROM users WHERE role='HOD';";
                  $ret = pg_query($db, $sql);
                  if (!$ret) {
