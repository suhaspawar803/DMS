        ...
        ?>
          ...
          <li class="nav-item menu-items active">
            ...
            <div class="collapse" id="util">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="Student_Edit.php">Add/Remove Student</a></li>
                <?php
                if ($role != 'Teacher') {
                ?>
                  ...
                  ?>
                    ...
                    if ($role != 'Principal') {
                    ?>
                      <li class="nav-item"><a class="nav-link" href="#">Add/Remove Principal</a></li>
                <?php
                    }
                  }
                }
        ...
        <div class="col-12 grid-margin">
          <div class="card" style="flex-direction: column;">
            <div class="card-body" style="background-color:#191c24;">
              ...
              <div class="preview-icon">
                  <span class="mdi mdi-account-plus" ></span>
                   <span class="menu-title" style="font-size:20px;">Add Principal</span> 
                </div>
              </a>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Name of the Principal</label>
                        <div class="col-sm-9">
            ...
            <div class="card-body" style="max-width:80%;overflow: auto;">
              <h3 id="h3head">Principal's Record</h3>
              <div id="tab" class="card-body">
                ...
                if (isset($_POST['add'])) {
                  ...
                  include '../../data.php';
                  if ($db) {
                    $sql = "INSERT INTO users VALUES(DEFAULT,'$name','$username','$pass','Principal','$library');";
                    $ret = pg_query($db, $sql);
                    if (!$ret) {
                      echo "<br>ERROR...<br>";
                    } else {
                ...
                include '../../data.php';
                if ($db) {
                  $sql = "SELECT * FROM users WHERE role='Principal';";
                  $ret = pg_query($db, $sql);
                  if (!$ret) {
                    ...
                    echo "<tr><th>Sr. No.</th>";
                    echo "<th>Name of the Principal</th>";
                    echo "<th>Email</th>";
                    echo "<th>Password</th>";
