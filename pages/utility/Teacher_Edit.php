          ...
          <li class="nav-item menu-items active">
            ...
            <div class="collapse" id="util">
              <ul class="nav flex-column sub-menu">
                ...
                if ($role != 'Teacher') {
                ?>
                  <li class="nav-item"><a class="nav-link" href="#">Add/Remove Teacher</a></li>
                  <?php
                  if ($role != 'HOD') {
                  ?>
        ...
        <div class="col-12 grid-margin">
          <div class="card" style="flex-direction: column;">
            <div class="card-body" style="background-color:#191c24;">
              ...
              <div class="preview-icon">
                  <span class="mdi mdi-account-plus" ></span>
                   <span class="menu-title" style="font-size:20px;">Add Teacher</span> 
                </div>
              </a>
            ...
            <div class="card-body" style="max-width:80%;overflow: auto;">
              <h3 id="h3head">Teacher's Record</h3>
              <div id="tab" class="card-body">
                ...
                if (isset($_POST['add'])) {
                  ...
                  include '../../data.php';
                  if ($db) {
                    $sql = "INSERT INTO users VALUES(DEFAULT,'$name','$username','$pass','Teacher','$library');";
                    $ret = pg_query($db, $sql);
                    if (!$ret) {
                      echo "<br>ERROR...<br>";
                    } else {
